...
window.PEOPLE_DATA = {
  people: [
    ...
    },
    {
      ...
      researchAffiliates: [
        { name: "Philippe Allard Guérin", role: "Senior research scientist (part-time), Université de Montréal, June 2026–", id: "philippe-allard-guerin" },
        { name: "Anantha Krishnan Sunilkumar", role: "Associate Researcher, DIRO, Université de Montréal", id: "anantha-krishnan-sunilkumar" },
      ],
      teaching: [
        {
          code: "IFT 6760c",
    ...
    },
    {
      ...
      en: {
        ...
        rank: "Senior research scientist (part-time) · Université de Montréal · June 2026–",
        researchAreaTags: [],
        links: [{ label: "Personal Website", url: "#" }],
        bio: [],
        researchInterests: [],
      ...
      fr: {
        ...
        nameFirst: "Philippe",
        nameLast: "Allard Guérin",
        rank: "Chercheur scientifique senior (temps partiel) · Université de Montréal · Juin 2026–",
        researchAreaTags: [],
        links: [{ label: "Site web personnel", url: "#" }],
        bio: [],
        researchInterests: [],
