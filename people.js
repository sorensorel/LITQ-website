...
window.PEOPLE_DATA = {
  people: [
    {
      ...
      formerStudents: [
        { name: "Claude Crépeau", role: "M.Sc. 1986" },
        { name: "Anne Broadbent", role: "M.Sc. 2004 · PhD 2008" },
    ...
    },
    {
      ...
      fr: {
        ...
        bio: [
          ...
          "Il a obtenu son doctorat de l'Université de Montréal et a occupé des postes postdoctoraux à l'Université d'Aarhus et à l'Université de Waterloo avant de revenir à Montréal. Il est un expert internationalement reconnu en cryptographie quantique et en théorie de la complexité.",
        ],
        researchInterests: [
          "Cryptographie quantique et distribution de clés quantiques",
          "Protocoles quantiques à deux parties et multipartites",
          "Théorie de la complexité et réductions",
    ...
    },
    {
      ...
      en: {
        ...
        links: [
          ...
          {
            label: "LinkedIn",
            url: "https://ca.linkedin.com/in/gena-hahn-2709a04",
          },
        ],
        bio: [
          "Gena Hahn is a full professor at the Department of Computer Science and Operations Research of Université de Montréal. His work focuses on graph theory and related areas, including combinatorics, algorithms, complexity, and communication in interconnection networks.",
          "He is particularly interested in theoretical and structural results, infinite graphs, and pursuit-evasion problems such as cops-and-robbers games on graphs. He holds a Ph.D. in fundamental mathematics from McMaster University and a Doctorat d'\u00c9tat in computer science from Universit\u00e9 Paris-Sud.",
        ],
        researchInterests: [
          "Graph theory and structural graph theory",
          "Infinite graphs",
          "Cops-and-robbers and pursuit-evasion games",
          "Graph homomorphisms and graph colouring",
          "Cayley graphs and graph symmetries",
          "Graph algorithms, combinatorics, and complexity",
      ...
      fr: {
        ...
        bio: [
          "Gena Hahn est professeur titulaire au Département d'informatique et de recherche opérationnelle de l'Université de Montréal. Ses travaux portent sur la théorie des graphes et ses domaines connexes, notamment la combinatoire, l'algorithmique, la complexité et les communications dans les réseaux d'interconnexion.",
          "Il s'intéresse particulièrement aux résultats théoriques et structurels, aux graphes infinis ainsi qu'aux problèmes de poursuite-évasion, dont les jeux de policiers et de voleurs sur les graphes. Il est titulaire d'un Ph. D. en mathématiques fondamentales de l'Université McMaster et d'un doctorat d'État en informatique de l'Université Paris-Sud.",
        ],
        researchInterests: [
          "Théorie et structure des graphes",
          "Graphes infinis",
          "Jeux de policiers et de voleurs et problèmes de poursuite-évasion",
          "Homomorphismes et coloration des graphes",
          "Graphes de Cayley et symétries des graphes",
          "Algorithmes de graphes, combinatoire et complexité",
          "Communications dans les réseaux d'interconnexion",
        ],
      },
    },
    {
    ...
    },
    {
      ...
      en: {
        ...
        nameLast: "Sunilkumar",
        rank: "PhD Student · DIRO, Université de Montréal",
        researchAreaTags: ["Quantum Information Theory", "Quantum Foundations"],
        links: [{ label: "Personal Website", url: "#" }],
        bio: [],
        researchInterests: [],
      },
      fr: {
        ...
        nameLast: "Sunilkumar",
        rank: "Doctorant(e) · DIRO, Université de Montréal",
        researchAreaTags: ["Théorie de l'information quantique", "Fondements quantiques"],
        links: [{ label: "Site web personnel", url: "#" }],
        bio: [],
        researchInterests: [],
      },
    ...
    },
    {
      ...
      fr: {
        ...
        bio: [
          "Je suis agent de recherche au sein de l'équipe de cryptographie et de calcul quantique du Centre de recherche en technologies numériques, ainsi que professeur associé à l'UdeM. Mon expertise porte sur la cryptographie quantique. Je m'intéresse à l'exploitation de l'information quantique pour des tâches cryptographiques avancées reposant sur des hypothèses moins contraignantes.",
          "Je fais également de la recherche en cryptographie post-quantique, la branche de la cryptographie classique qui s'intéresse à la sécurité face à un adversaire quantique. Je m'intéresse aussi aux solutions cryptographiques permettant d'effectuer des calculs tout en protégeant la vie privée.",
        ],
        researchInterests: [
    ...
    },
    {
      ...
      fr: {
        ...
        nameLast: "Badiambile",
        rank: "Étudiant(e) à la maîtrise · DIRO, Université de Montréal",
        researchAreaTags: ["Théorie des graphes", "Combinatoire"],
        email: "gianluca.badiambile@gmail.com",
        links: [{ label: "Site web personnel", url: "#" }],
        bio: [],
        researchInterests: [],
  ...
  pastStudents: [
    ...
    },
    {
      ...
      year: "1991",
      supervisor: "Gilles Brassard",
      note: "Complexity Theory, Computability · <a href=\"https://marcoux.ebsi.umontreal.ca/\" target=\"_blank\" rel=\"noopener\">Personal Website</a>",
    },
    {
      name: "Louis-Charles Thibodeau",
      degree: "MSc",
      year: "2025",
    ...
    {
      name: "Frank Ramamonjisoa",
      degree: "PhD",
      year: "2023",
      supervisor: "Gena Hahn",
      note: "",
    },
    {
      name: "Shany Xiye Gazaille",
      degree: "MSc",
      year: "2023",
      supervisor: "Louis Salvail",
      note: "",
    ...
    {
      name: "Philippe Lamontagne",
      degree: "PhD",
      year: "2018",
      supervisor: "Louis Salvail",
      note: "Now adjunct professor at LITQ",
    },
    {
      name: "Maxime Beaudry",
      degree: "MSc",
    ...
    },
    {
      ...
      degree: "PhD",
      year: "2009",
      supervisor: "Gilles Brassard · Patrick Hayden",
      note: "Now associate professor at LITQ",
    },
    {
      name: "Anne Broadbent",
      degree: "PhD",
      year: "2008",
      supervisor: "Gilles Brassard · Alain Tapp",
      note: "",
    },
    {
      name: "Amal El Ouarari",
      degree: "MSc",
      year: "2007",
      supervisor: "Gena Hahn",
      note: "",
    },
    {
      ...
      degree: "PhD",
      year: "1998",
      supervisor: "Gilles Brassard · Claude Crépeau",
      note: "",
    },
    {
      name: "Louis Salvail",
      ...
      year: "1997",
      supervisor: "Gilles Brassard · Claude Crépeau",
      note: "Now full professor at LITQ",
    },
    {
      name: "Claude Crépeau",
      degree: "MSc",
